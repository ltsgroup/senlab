...
const Backer: FC<Props> = ({ title }) => {
  return (
    <div className="border-b border-solid border-[#185BEA] bg-[#fff] mobile:border-b-0 mobile:py-[45px]">
      ...
      <div className="hidden mobile:block">
        <div className="whitespace-pre-line px-[20px] py-[40px] text-center font-bold text-[30px] capitalize leading-9 text-[#231F20]">
          {title}
        </div>
